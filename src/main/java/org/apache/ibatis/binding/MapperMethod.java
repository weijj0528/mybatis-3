...
public class MapperMethod {
  ...
  /**
   * Execute object.
   * 最终执行的为 sqlSession.insert/update/delete/select相关方法
   * {@link SqlSession#insert}
   * {@link SqlSession#update}
   * {@link SqlSession#delete}
   * {@link SqlSession#select}
   *
  ...
  public static class SqlCommand {
     ...
     * eg: org.apache.ibatis.autoconstructor.AutoConstructorMapper.getSubject2
     */
